...
app.use('/productSearch', products.search)
...
app.use('/viewListMem?', admin.viewListMem)
app.use('/viewListCart?', admin.viewListCart)
app.use('/viewDonHang?', admin.viewListProductOfUser)
app.use('/deleteproductOfUser?', admin.deleteproductOfUser)
